...
INSERT INTO Usuarios (nombre, apellido, fechaNacimiento, usuario, contraseña, email, Telefono, idTipoUsuario) 
...
@cod varchar(5)
as
SELECT foto FROM Productos WHERE codigoProducto = @cod;
go
...
@image image
as
UPDATE Productos SET foto = @image WHERE codigoProducto = @cod;
go
